...
#define HIDDEN_OAK_INVISIBLE_FLAGS_END        (HIDDEN_OAK_INVISIBLE_FLAGS_START + MAX_HIDDEN_OAK_COUNT - 1) // 0x146 eventually, for now 0x0B4
...
// Hidden Oak visibility
#define HIDDEN_OAK_FOUND_FLAGS_START      0x300
#define HIDDEN_OAK_FOUND_FLAGS_END        (HIDDEN_OAK_FOUND_FLAGS_START + MAX_HIDDEN_OAK_COUNT - 1) // 0x396
